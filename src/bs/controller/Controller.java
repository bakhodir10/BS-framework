...
public class Controller {
    ...
    void initializeButtons() {
        ...
        JButton_NewPerson.setText("Add personal acc");
        JButton_NewPerson.setBounds(24, 20, 130, 33);
        ...
        JButton_AccReport.setText("Acc Report");
        JButton_AccReport.setActionCommand("jbutton");
        JButton_AccReport.setBounds(320, 20, 130, 33);
        view.addButton(JButton_AccReport);

        JButton_AddInterest.setBounds(460, 20, 106, 33);
        ...
        JButton_NewPerson.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                JDialog_Custom jd = new JDialog_Custom(view, "Add personal account");
                preparePersonAccount(jd);
                jd.setBounds(450, 20, 300, 330);
                jd.show();

                if (view.newaccount) {
                    ICustomer personal = new Person(view.clientName, view.street, view.city, view.state, view.zip,
                            view.email, now);
                    IAccount account = new Account(view.accountnr, personal);
                    finco.create(personal, account);
                    // TODO how to show it from the list
                    view.rowdata[0] = view.accountnr;
                    view.rowdata[1] = view.clientName;
                    view.rowdata[2] = view.city;
                    view.rowdata[3] = "P";
                    // view.rowdata[4] = view.accountType;
                    view.rowdata[4] = "0";
        ...
        JButton_NewCompany.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (view.newaccount) {
                    ...
                    view.rowdata[3] = "C";
                    // view.rowdata[4] = view.accountType;
                    // view.rowdata[5] = view.numberOfEmployee;
                    view.rowdata[4] = "0";
                    view.model.addRow(view.rowdata);
        ...
        JButton_Deposit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selection >= 0) {
                    ...
                    IAccount acc = new Account(accnr, null);
                    finco.deposit(acc, deposit);

                    // TODO update view
                    String samount = (String) view.model.getValueAt(selection, 4);
                    long currentamount = Long.parseLong(samount);
                    long newamount = currentamount + deposit;
                    view.model.setValueAt(String.valueOf(newamount), selection, 4);
                }
            }
        });
        ...
        JButton_Withdraw.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (selection >= 0) {
                    ...
                    long withDraw = Long.parseLong(view.amountwithDraw);
                    String samount = (String) view.model.getValueAt(selection, 4);
                    long currentamount = Long.parseLong(samount);
    ...
    void prepareAccReportWindow(JDialog_Custom c) {
        ...
        String billstring = finco.accountReport();
