...
//        rowdata = new Object[8];
	...
	void JButtonNewCCAC_actionPerformed(ActionEvent event)
	{
		...
		*/
		...
		JDialog_AddCCAccount ccac = new JDialog_AddCCAccount(null);
//		JDialog_AddCCAccount ccac = new JDialog_AddCCAccount(thisframe);
	...
	void JButtonDeposit_actionPerformed(ActionEvent event)
	{
        ...
        if (selection >=0){
		    ...
		    JDialog_Deposit dep = new JDialog_Deposit(null,name);
//		    JDialog_Deposit dep = new JDialog_Deposit(thisframe,name);
	...
	void JButtonWithdraw_actionPerformed(ActionEvent event)
	{
        ...
        if (selection >=0){
		    ...
		    JDialog_Withdraw wd = new JDialog_Withdraw(null,name);
